            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin/user/danhsach"><i class="fa fa-users fa-fw"></i>Nguoi Dung<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/users/danhsach">Danh Sach</a>
                                </li>
                                <li>
                                    <a href="admin/users/them">Them</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
